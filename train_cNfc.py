...
if __name__ == "__main__":
    ...
    for epoch in range(0, args.epoch):
        ...
        for step in record_index_shuffled[:num_index_samples]:
            ...
            grid_label_after_50_tensor = torch.tensor(np.array(grid_label_after_50_array)).to(device) # (num_vehicle_samples - len(counter_exclude_array), grid_size[0], grid_size[1])
